...
const Hero = () => (
  <section
    id="home"
    className={`flex md:flex-row flex-col pt-0 ${defaultStyles.paddingY}`}
  >
    <div
      className={`flex-1 ${defaultStyles.flexStart} flex-col pt-0 xl:px-0 sm:px-16 px-6`}
    >
      ...
      <p className={`${defaultStyles.paragraph} max-w-[470px] mt-5`}>
        ...
        rich culture of productive builders assisting in creating network effect
        for the LUKSO blockchain.
      </p>
    </div>

    <div
      className={`flex-1 flex ${defaultStyles.flexCenter} md:my-0 my-10 relative`}
    >
    ...
    <div className={`ss:hidden ${defaultStyles.flexCenter}`}>
      <GetStarted />
    </div>
  </section>
);
